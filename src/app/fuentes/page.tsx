...
export default function SourcesPage() {
  return <main className="info-page" id="main-content"><InfoHeader />
    ...
    <section className="snapshot-status"><div><span>SNAPSHOT ACTIVO</span><b>ar-24-2026-07</b></div><div><span>COBERTURA</span><b>24 ciudades</b></div><div><span>MOTOR</span><b>rules-v1.0.0</b></div><div><span>ESTADO</span><b>Baseline editorial</b></div></section>
    ...
    <section className="cost-method"><p className="eyebrow">COSTOS Y ALQUILER</p><h2>Es el dato más volátil y el mayor límite actual.</h2><p>Los rangos actuales son estimaciones editoriales para exploración. Antes de tratarlos como métrica trazable, cada ciudad debe tener muestra comparable, fecha, tamaño, evidencia y caducidad de 45 días. No scrapeamos ni republicamos anuncios contra sus términos.</p></section>
